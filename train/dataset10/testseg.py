...
#使用相对路径
MODEL_PATH = current_dir / "train_seg" / "run_20251231_104131" / "weights" / "best.pt"
...
# 清除上一次 test 的临时预测结果和最终标签，避免重复复制或累积
test_run_dir = TEMP_SAVE_DIR / "test_run"
if test_run_dir.exists():
    shutil.rmtree(test_run_dir)

for existing_txt in FINAL_LABELS_DIR.glob("*.txt"):
    try:
        existing_txt.unlink()
    except Exception:
        pass
